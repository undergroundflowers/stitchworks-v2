 ...
 * to read in inline styles. The four exported objects below are intentionally
 * mutable (no `as const`) so the Vibe theming system can rewrite them at
 * runtime via `applyVibe`.
 */
...
export const SW_RADIUS = { sm: 6, md: 10, lg: 14, xl: 22 };
