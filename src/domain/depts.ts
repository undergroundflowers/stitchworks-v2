 ...
 * different shape; these depts catalogue items use the cycleS / costHr /
 * power shape the dept screen expects.
 */
...
export const DEPT_MACHINE_CATALOG: Record<DeptMachineId, DeptMachineSpec> = {
  // Spreading
  spread_table:   { id:'spread_table',   label:'Spread Table',        icon:'≡', cat:'spread', cycleS:[35,75], costHr:7,  power:1.2 },
  auto_spreader:  { id:'auto_spreader',  label:'Auto Spreader',       icon:'⇉', cat:'spread', cycleS:[18,30], costHr:14, power:3.5 },
  // Cutting
  cut_table:      { id:'cut_table',      label:'Cutting Table',       icon:'─', cat:'cut',    cycleS:[40,90], costHr:8,  power:0.6 },
  straight_knife: { id:'straight_knife', label:'Straight Knife',      icon:'⫻', cat:'cut',    cycleS:[40,80], costHr:9,  power:1.4 },
  band_knife:     { id:'band_knife',     label:'Band Knife',          icon:'⋮', cat:'cut',    cycleS:[30,55], costHr:10, power:2.1 },
  cnc_cutter:     { id:'cnc_cutter',     label:'CNC Auto Cutter',     icon:'◇', cat:'cut',    cycleS:[12,22], costHr:22, power:5.0 },
  // Sewing
  ssm:            { id:'ssm',            label:'Single-Needle Lock',  icon:'⌃', cat:'sew',    cycleS:[20,50], costHr:8,  power:0.4 },
  overlock:       { id:'overlock',       label:'4-Thread Overlock',   icon:'⤴', cat:'sew',    cycleS:[18,36], costHr:9,  power:0.5 },
  flatlock:       { id:'flatlock',       label:'Flatlock',            icon:'≣', cat:'sew',    cycleS:[22,40], costHr:9,  power:0.55 },
  bartack:        { id:'bartack',        label:'Bartack',             icon:'∥', cat:'sew',    cycleS:[8,16],  costHr:10, power:0.6 },
  buttonhole:     { id:'buttonhole',     label:'Buttonhole',          icon:'◉', cat:'sew',    cycleS:[10,18], costHr:11, power:0.55 },
  buttonsew:      { id:'buttonsew',      label:'Button Sew',          icon:'•', cat:'sew',    cycleS:[6,12],  costHr:10, power:0.5 },
  feed_off_arm:   { id:'feed_off_arm',   label:'Feed-off-the-Arm',    icon:'⌒', cat:'sew',    cycleS:[24,42], costHr:11, power:0.6 },
  // QC
  qc_table:       { id:'qc_table',       label:'QC Inspection Table', icon:'◎', cat:'qc',     cycleS:[22,40], costHr:9,  power:0.15 },
  metal_detect:   { id:'metal_detect',   label:'Metal Detector',      icon:'⊜', cat:'qc',     cycleS:[5,10],  costHr:7,  power:0.4 },
  // Press / finishing
  press_table:    { id:'press_table',    label:'Pressing Table',      icon:'▤', cat:'press',  cycleS:[28,50], costHr:7,  power:1.8 },
  steam_iron:     { id:'steam_iron',     label:'Steam Iron',          icon:'◆', cat:'press',  cycleS:[18,32], costHr:7,  power:2.2 },
};
